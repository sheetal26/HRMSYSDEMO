<%@ Page Title="" Language="C#" MasterPageFile="~/MasterHome.master" AutoEventWireup="true" CodeFile="~/HomePage.aspx.cs" Inherits="HomePage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderPage" runat="Server">
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 1000)); //600
                else
    ...
    <div id="HeadDiv" runat="server" class="content_resize" style="-moz-border-radius: 50px; -webkit-border-radius: 50px; border-radius: 50px;">
        ...
        <div class="content"> 
            ...
            <div id="Div1" runat="server" style="width: 1065px; height: 340px; background-color: #CCD0DB;
                            margin: 10px; -moz-border-radius: 25px; -webkit-border-radius: 25px; border-radius: 25px;"> 
                <!-- Jssor Slider Begin -->
                <!-- You can move inline styles to css file or css block. -->

                <div id="slider1_container" style="position: relative; width: 1000px;
                    height: 300px; overflow: hidden; top: 20px; left: 30px;">
                    ...
                    <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 1000px; height:300px;
                        overflow: hidden;">
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/01.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            slideshow transition twins
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/02.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            random caption transition
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/03.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            mobile ready, touch swipe
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/04.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                        ...
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/05.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            slideshow transition twins
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/06.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            random caption transition
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/07.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            mobile ready, touch swipe
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/08.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            responsive, scale smoothly
                            </div>
                        </div>
                        ...
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/09.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            slideshow transition twins
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/10.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            random caption transition
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/11.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            mobile ready, touch swipe
                            </div>
                        </div>
                        <div>
                            <a u=image href="#"><img src="images/Slider/landscape/12.jpg" /></a>
                            <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:300px; height:30px;"> 
                            responsive, scale smoothly
                            </div>
                        </div>
            ...
            <div runat="server" style="width: 1120px; height: 650px;">
                <div runat="server" style="width: 1120px; height: 320px;">
                    <div runat="server" class="divRadius">
                        <table runat="server">
                            <tr>
                                <th></th>
                                <td></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="TxtLoginName" runat="server" Text="Nothing" BorderColor="White" Enabled="False" ReadOnly="True" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th style="text-align: left;">
                                    <asp:Label ID="LblEMailId" runat="server" Text="Login EMail-Id "></asp:Label>
                                </th>
                                <td>
                                    <asp:TextBox ID="TxtEMailId" runat="server" Text="Nothing" BorderColor="White" Enabled="False" ReadOnly="True" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <th style="text-align: left;">
                                ...
                                <td>
                                    <asp:TextBox ID="TxtLoginId" runat="server" Text="Nothing" BorderColor="White" Enabled="False" ReadOnly="True" Width="200px"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <marquee direction="Up" onmouseover="this.stop()" onmouseout="this.start()">
                                        <strong> 
                                            <a href="#">1. Simple Marquee With Hyperlink In Up Direction</a><br/>
                                            <a href="#">2. Simple Marquee With Hyperlink In Up Direction</a><br/>
                                            <a href="#">3. Simple Marquee With Hyperlink In Up Direction</a><br/>
                                            <a href="#">4. Simple Marquee With Hyperlink In Up Direction</a><br/>
                                        </strong></marquee>
                                </td>
                            </tr>
                        </table>
                ...
                <%--<div runat="server" style="width: 1120px; height: 320px; border: thin; border-color: green;">
                    <div runat="server" class="divRadius">
                    </div>
                    <div runat="server" class="divRadius">
                    </div>
