<%@ Page Title="" Language="C#" MasterPageFile="~/MasterHome.master" AutoEventWireup="true" CodeFile="UserGroup.aspx.cs" Inherits="Utilities_UserGroup" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolderhead" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=TxtGrpName.ClientID%>").value == "") {
                str = str + "Group Name Is Blank, Enter Valid Group Value. \n";
            }
            if (str == "") {
                return (true);
            }
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:TextBox ID="TxtGrpName" runat="server" MaxLength="100" Text="" Width="325px"></asp:TextBox>
                            </td>
                            <td colspan="2" style="text-align: left;">
                        ...
                        <tr>
                            <td colspan="3" style="text-align: left;">
                                <%--AutoGenerateDeleteButton="True" AutoGenerateEditButton="True"  OnRowDeleting="GridUserGrp_RowDeleting"--%>
                                <asp:GridView ID="GridUserGrp" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    PageSize="15" DataKeyNames="Id"
                                    OnRowCancelingEdit="GridUserGrp_RowCancelingEdit"
                                    OnRowEditing="GridUserGrp_RowEditing"
                                    OnRowUpdating="GridUserGrp_RowUpdating"
                                    OnPageIndexChanging="GridUserGrp_PageIndexChanging" CssClass="mGrid">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Grp.Name">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TxtUGrpName" runat="server" Width="350px" BorderStyle="None" ForeColor="Black" Text='<%# Bind("UGrpName") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="LblUGrpName" runat="server" Text='<%# Bind("UGrpName") %>' Width="350px" ForeColor="Black"></asp:Label>
                                            </ItemTemplate>
