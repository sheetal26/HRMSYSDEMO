<%@ Page Title="" Language="C#" MasterPageFile="~/MasterHome.master" AutoEventWireup="true" CodeFile="DepartmentMast.aspx.cs" Inherits="Masters_DepartmentMast" %>
    ...
    <script type="text/javascript">
        ...
        function validate() {
            ...
            if (document.getElementById("<%=TxtDeptName.ClientID%>").value == "") {
                str = str + "Department Name Is Blank, Enter Valid Department Value. \n";
            }
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <asp:TextBox ID="TxtDeptName" runat="server" MaxLength="50" Text="" Width="250px"></asp:TextBox>
                            </td>
                        ...
                        <tr>
                            <td colspan="3">
                               <%-- AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="GridDept_RowDeleting"--%>
                                <asp:GridView ID="GridDept" runat="server" AllowPaging="True" AutoGenerateColumns="False"                                    
                                    DataKeyNames="Id" PageSize="15"
                                    OnPageIndexChanging="GridDept_PageIndexChanging"                                    
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Dept.Name">
                                            <EditItemTemplate>
                                                <asp:TextBox ID="TxtDeptName" runat="server" Width="350px" BorderStyle="None" ForeColor="Black" Text='<%# Bind("DeptName") %>'></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                                <asp:Label ID="LblDeptName" runat="server" Text='<%# Bind("DeptName") %>' Width="350px" ForeColor="Black"></asp:Label>
                                            </ItemTemplate>
